...
--
-- Servidor: localhost
-- Tiempo de generación: 29-05-2019 a las 19:16:17
...
INSERT INTO `animal` (`id_animal`, `raza_animal`, `especie_animal`, `sexo_animal`, `descripcion_animal`, `castrado`) VALUES
(1, 'Beagle', '', '', '', 0);
...
ALTER TABLE `imagen`
  ...
  ADD CONSTRAINT `imagen_ibfk_2` FOREIGN KEY (`id_animal`) REFERENCES `animal` (`id_animal`);
COMMIT;
